...
for ($i=0; $i < 2000; $i++) { 
	$point = Tools::generateRandomPoint(TEST_LAT, TEST_LNG, 100);
	$request = Requests::post(Tools::getAPIURL()."/shop/edit", array("token"=> $token), array("name"=>Tools::generateRandomString(), "street"=> Tools::generateRandomString(40), "city"=>Tools::generateRandomString(), "zip"=>Tools::generateRandomString(5), "lat"=>$point[0], "lng"=>$point[1]));
}
